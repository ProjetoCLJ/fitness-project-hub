        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold mb-3">
              Cadastro de <span className="bg-gradient-hero bg-clip-text text-transparent">Aluno</span>
            </h1>
            <p className="text-muted-foreground">Preencha seus dados para começar sua jornada fitness</p>
          </div>
          ...
          <Card className="p-8 shadow-medium">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="description"
                  placeholder="Conte um pouco sobre seus objetivos e expectativas (opcional)"
